            ...
            <vue-tailwind-datepicker class="max-w-80" v-model="dateBirthVal.gV" v-slot="{ placeholder }" as-single
              ...
              <label class="relative w-full">
                ...
                <div class="relative h-10 w-full flex items-center">
                  ...
                  <input @focusout="handleDateFocusout" v-maska data-maska="##.##.####" v-model="dateBirthVal.sV"
...
data.value.date_birth = dateBirthVal.value.gV;
...
const handleDateFocusout = (e: Event) => {
  if (dateBirthVal.value.sV === '') dateFlag.value = false;
  else dateFlag.value = !/^(0[1-9]|[12][0-9]|3[01])\.(0[1-9]|1[0-2])\.(19[5-9]\d|20\d{2})$/.test(dateBirthVal.value.sV);
}
